...
import { handleRestoreSubscriptionMigrationNoAuth } from "../../handlers/migrationHandlers";

export const restoreSubscriptionMigrationNoAuth = functions.region(REGION).https.onRequest(
